...
{
    public sealed partial class Test1OOPCourseForm : UniversityEnvironment.View.Forms.BaseTestForm
    {
        public Test1OOPCourseForm()
        {
            InitializeComponent();
        }
        public Test1OOPCourseForm(Models.User user, Course course, Test test) : base(user, course, test)
        {
            InitializeComponent();
        ...
        private void SendButton_Click(object sender, EventArgs e)
        {
            ...
            List<bool> question2 = new List<bool> { Q2Answer1.Checked, Q2Answer2.Checked };
