...
{
    public sealed partial class Test1CybersecurityCourseForm : UniversityEnvironment.View.Forms.BaseTestForm
    {
        public Test1CybersecurityCourseForm()
        {
            InitializeComponent();
        }
        public Test1CybersecurityCourseForm(Models.User user, Course course, Test test) : base(user, course, test)
        {
            InitializeComponent();
